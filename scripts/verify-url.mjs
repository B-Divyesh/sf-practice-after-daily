...
if (!response?.ok()) errors.push(`Navigation status: ${response?.status() ?? 'no response'}`);
...
console.log(`Verified ${url}: title, lang, one h1, main, image alt attributes, and no console errors.`);
